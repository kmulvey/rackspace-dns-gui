		...
		var nameIndex = 0;
				...
				if (typeof req.body.domain_name === 'string') {
					...
					nameIndex++;
                                ...
                                domain.initAll('', req.body.domain_id[i], req.body.domain_comment[i], req.body.domain_accountId[i],
                                               req.body.domain_ttl[i], req.body.domain_emailAddress[i], req.body.domain_updated[i], req.body.domain_created[i]);
